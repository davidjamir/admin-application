...
export async function POST(req: Request) {
  try {
    ...
    switch (action) {
      case "list": {
        const groups = await facebookAssetGroupService.getBusinessAssetGroups(token, businessId!)
      ...
      case "update": {
        ...
        await facebookAssetGroupService.updateBusinessAssetGroup(token, assetGroupId, name)
      ...
      case "delete": {
        ...
        await facebookAssetGroupService.deleteBusinessAssetGroup(token, assetGroupId)
      ...
      case "assigned-users": {
        ...
        const users = await facebookAssetGroupService.getAssetGroupAssignedUsers(
          token,
          assetGroupId,
          businessId!
        )
      ...
      case "assign-user": {
        ...
        await facebookAssetGroupService.assignUserToAssetGroup(
          token,
          assetGroupId,
          businessId!,
          userId,
      ...
      case "remove-user": {
        ...
        await facebookAssetGroupService.removeUserFromAssetGroup(
          token,
          assetGroupId,
          businessId!,
          userId
      ...
      case "contained-pages": {
        ...
        const pages = await facebookAssetGroupService.getAssetGroupContainedPages(token, assetGroupId)
      ...
      case "add-page": {
        ...
        await facebookAssetGroupService.addPageToAssetGroup(token, assetGroupId, pageId)
      ...
      case "remove-page": {
        ...
        await facebookAssetGroupService.removePageFromAssetGroup(token, assetGroupId, pageId)
